			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<label for="dname">부서명</label> <input
							type="text" class="form-control" id="dname" name="dname" placeholder="부서명 : ">
					</div>
					<div class="form-group">
						<label for="loc">지역명</label> <input
							type="text" class="form-control" id="loc" name="loc" placeholder="지역명 : ">
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<button type="button" class="btn btn-primary btn-lg"
					data-toggle="modal" data-target="#myModal">입력</button>
			</div>
		</div>
	</div>
</body>
